...
import { CalendarDays, HardDrive, Info, Layers, ListChecks, Loader2, User } from 'lucide-react';
...
export function MeusEspacosPageClient() {
  ...
  const managedEspacos = useMemo(
    () => managedEspacosLinks?.map(link => link.espaco) ?? [],
    [managedEspacosLinks],
  );
  ...
  return (
    <div className="h-full flex-1 flex-col md:flex">
      <ResizablePanelGroup
        ...
        className="h-full max-h-[calc(100vh-180px)] rounded-lg border"
      >
                ...
                ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Gerencie as solicitações, informações e recursos do seu espaço.
                      </p>
                      ...
                      <Tabs defaultValue="solicitacoes" className="w-full">
                        <TabsList className="grid w-full grid-cols-6">
                          ...
                          <TabsTrigger
                            value="gestores"
                            disabled={!access.canManageEspacoGestores}
                          >
                        ...
                        <TabsContent value="informacoes" className="mt-6">
                          <EspacoDetailsForm entity={selectedEspaco} onSuccess={() => {}} />
                        </TabsContent>
