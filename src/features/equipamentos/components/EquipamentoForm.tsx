...
export function EquipamentoForm({ entity: equipamento, onSuccess }: EquipamentoFormProps) {
  ...
  const { data: allTipos } = useGetAllTiposEquipamento();
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Ex: 123456-ABC" {...field} disabled={isEditMode} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Qualquer detalhe relevante sobre o item..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
